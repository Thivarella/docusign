...
public final class EnvelopeHelpers {
    ...
    static Template loadHtmlTemplate(String path) throws IOException {
        ...
        String source = StreamUtils.copyToString(EnvelopeHelpers.class.getClassLoader().getResourceAsStream(path), StandardCharsets.UTF_8);
    ...
    static byte[] createHtmlFromTemplate(Template template, String objectName, Object value) throws IOException {
        ...
        try {
            ...
            throw new IOException("Can't process html template " + template.getName(), exception);
        }
    }
